...
# 👋 Hello, I'm Hussam Al-Jawad

<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&pause=1000&color=00D9FF&center=true&vCenter=true&width=435&lines=Passionate+Developer;Tech+Enthusiast;Always+Learning" alt="Typing SVG" />

<img src="https://github.com/SP-XD/SP-XD/blob/main/images/dev-working_rounded.gif?raw=true" alt="Developer" width="40%"/>

---

### 💫 About Me

> A passionate developer with a deep love for programming and technology, constantly exploring new horizons in the world of code.
...
class HussamSkills {
    public:
        vector<string> languages = {"C++", "HTML", "CSS"};
        vector<string> tools = {"Git", "GitHub", "VS Code"};
        string passion = "Programming & Technology";
        
        void introduce() {
            cout << "Hello! I'm Hussam, a developer passionate about learning and building amazing things!" << endl;
        }
};
```
